# Platform p2 repository: Eclipse 4.38.0 Release Build: 4.38

Online Eclipse p2 `platform repository 4.38.0`, including `FreeBSD aarch64/x86_64` artifacts,
built from my [fork](https://github.com/chirontt/eclipse.platform.releng.aggregator/tree/R4_38_maintenance)
of the [Aggregator repo for Eclipse SDK builds](https://github.com/eclipse-platform/eclipse.platform.releng.aggregator),
to supplement the official Eclipse [4.38](https://download.eclipse.org/eclipse/updates/4.38/) p2 repository.

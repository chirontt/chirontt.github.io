# Platform p2 repository: Eclipse 4.39.0 Release Build: 4.39

Online Eclipse p2 `platform repository 4.39.0`, including `FreeBSD aarch64/x86_64` artifacts,
built from my [fork](https://github.com/chirontt/eclipse.platform.releng.aggregator/tree/R4_39_maintenance)
of the [Aggregator repo for Eclipse SDK builds](https://github.com/eclipse-platform/eclipse.platform.releng.aggregator),
to supplement the official Eclipse [4.39](https://download.eclipse.org/eclipse/updates/4.39/) p2 repository.

# Platform p2 repository: Eclipse 4.37.0 Release Build: 4.37

Online Eclipse p2 `platform repository 4.37.0`,
including `FreeBSD aarch64/x86_64` artifacts, built from my [fork](https://github.com/chirontt/eclipse.platform.releng.aggregator/tree/R4_37_maintenance)
of the [Aggregator repo for Eclipse SDK builds](https://github.com/eclipse-platform/eclipse.platform.releng.aggregator),
to supplement the official Eclipse [4.37](https://download.eclipse.org/eclipse/updates/4.37/) p2 repository.

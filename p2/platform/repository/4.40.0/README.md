# Platform p2 repository: Eclipse 4.40.0 Release Build: 4.40

Online Eclipse p2 `platform repository 4.40.0`, including `FreeBSD aarch64/x86_64` artifacts,
built from my [fork](https://github.com/chirontt/eclipse.platform.releng.aggregator/tree/R4_40_maintenance)
of the [Aggregator repo for Eclipse SDK builds](https://github.com/eclipse-platform/eclipse.platform.releng.aggregator),
to supplement the official Eclipse [4.40](https://download.eclipse.org/eclipse/updates/4.40/) p2 repository.

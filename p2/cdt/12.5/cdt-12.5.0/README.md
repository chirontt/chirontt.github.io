...
Online Eclipse CDT `12.5.0` p2 repo, including `FreeBSD aarch64/x86_64` artifacts,
...
to supplement the official Eclipse CDT [12.5.0](https://download.eclipse.org/tools/cdt/releases/12.5/cdt-12.5.0/)
p2 repository.
